...
class CusDrawerDay18 extends StatefulWidget {
  const CusDrawerDay18({super.key});

  @override
  State<CusDrawerDay18> createState() => _CusdrawerState();
}

class _CusdrawerState extends State<CusDrawerDay18> {
  int selectedindex = 0;
